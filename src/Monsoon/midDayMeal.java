...
public class midDayMeal {
    ...
    public midDayMeal() {
        ...
        option1[0].setFood("mango");
        option1[0].setQuantity(1.0);
        ...
        option2[0].setFood("jackfruit");
        option2[0].setQuantity(8.0);
        option2[0].setTypeOfQuantity("pieces");
    ...
    public midDayMeal(double fruits,double bread,double bannana) {
        ...
        option2[0].setFood("jack fruit");
        option2[0].setQuantity(fruits*8);
